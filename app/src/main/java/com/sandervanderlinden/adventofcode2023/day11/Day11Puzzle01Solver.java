 ...
 */
public class Day11Puzzle01Solver extends Day11PuzzleSolver {

    private static final Logger logger = Logger.getLogger(Day11Puzzle01Solver.class.getName());
    ...
    public static void main(String[] args) {
        Day11Puzzle01Solver solver = new Day11Puzzle01Solver();
